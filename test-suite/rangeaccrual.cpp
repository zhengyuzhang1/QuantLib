...
namespace {
    ...
    struct CommonVars {
        ...
        void createYieldCurve() {
            ...
            dates.emplace_back(39147);    dates.emplace_back(39148);    dates.emplace_back(39151);
            dates.emplace_back(39153);    dates.emplace_back(39159);    dates.emplace_back(39166);
            dates.emplace_back(39183);    dates.emplace_back(39294);    dates.emplace_back(39384);
            dates.emplace_back(39474);    dates.emplace_back(39567);    dates.emplace_back(39658);
            dates.emplace_back(39748);    dates.emplace_back(39839);    dates.emplace_back(39931);
            dates.emplace_back(40250);    dates.emplace_back(40614);    dates.emplace_back(40978);
            dates.emplace_back(41344);    dates.emplace_back(41709);    dates.emplace_back(42074);
            dates.emplace_back(42441);    dates.emplace_back(42805);    dates.emplace_back(43170);
            dates.emplace_back(43535);    dates.emplace_back(43900);    dates.emplace_back(44268);
            dates.emplace_back(44632);    dates.emplace_back(44996);    dates.emplace_back(45361);
            dates.emplace_back(45727);    dates.emplace_back(46092);    dates.emplace_back(46459);
            dates.emplace_back(46823);    dates.emplace_back(47188);    dates.emplace_back(47553);
            dates.emplace_back(47918);    dates.emplace_back(48283);    dates.emplace_back(48650);
            dates.emplace_back(49014);    dates.emplace_back(49379);    dates.emplace_back(49744);
            dates.emplace_back(50110);    dates.emplace_back(53762);    dates.emplace_back(57415);
