...
test_suite* init_unit_test_suite(int, char*[]) {
    ...
    bm.emplace_back("AmericanOption::FdAmericanGreeks",
        &AmericanOptionTest::testFdAmericanGreeks, 518.31);
    bm.emplace_back("AmericanOption::FdShoutGreeks",
    ...
    bm.emplace_back("BarrierOption::BabsiriValues",
        &BarrierOptionTest::testBabsiriValues, 880.8);
    bm.emplace_back("BasketOption::EuroTwoValues",
        &BasketOptionTest::testEuroTwoValues, 340.04);
    bm.emplace_back("BasketOption::TavellaValues",
        &BasketOptionTest::testTavellaValues, 933.80);
    bm.emplace_back("BasketOption::OddSamples",
        &BasketOptionTest::testOddSamples, 642.46);
    bm.emplace_back("BatesModel::DAXCalibration",
        &BatesModelTest::testDAXCalibration, 1993.35);
    bm.emplace_back("ConvertibleBondTest::testBond",
        &ConvertibleBondTest::testBond, 159.85);
    bm.emplace_back("DigitalOption::MCCashAtHit",
        &DigitalOptionTest::testMCCashAtHit,995.87);
    bm.emplace_back("DividendOption::FdEuropeanGreeks",
        &DividendOptionTest::testFdEuropeanGreeks, 949.52);
    bm.emplace_back("DividendOption::FdAmericanGreeks",
        &DividendOptionTest::testFdAmericanGreeks, 1113.74);
    bm.emplace_back("EuropeanOption::FdMcEngines",
        &EuropeanOptionTest::testMcEngines, 1988.63);
    bm.emplace_back("EuropeanOption::ImpliedVol",
        &EuropeanOptionTest::testImpliedVol, 131.51);
    bm.emplace_back("EuropeanOption::FdEngines",
        &EuropeanOptionTest::testFdEngines, 148.43);
    bm.emplace_back("EuropeanOption::PriceCurve",
        &EuropeanOptionTest::testPriceCurve, 414.76);
    bm.emplace_back("FdHestonTest::testFdmHestonAmerican",
        &FdHestonTest::testFdmHestonAmerican, 234.21);
    bm.emplace_back("HestonModel::DAXCalibration",
    ...
    bm.emplace_back("JumpDiffusion::Greeks",
    ...
    bm.emplace_back("MarketModelSmmTest::testMultiSmmSwaptions",
        ...
        11244.95);
    bm.emplace_back("QuantoOption::ForwardGreeks",
    ...
    bm.emplace_back("RiskStatistics::Results",
        &RiskStatisticsTest::testResults, 300.28);
    bm.emplace_back("ShortRateModel::Swaps",
