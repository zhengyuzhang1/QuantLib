...
namespace {
    ...
    CalibrationData AndreasenHugeExampleData() {
        ...
        std::vector<Time> maturityTimes = {0.025, 0.101, 0.197, 0.274, 0.523, 0.772,
                                           1.769, 2.267, 2.784, 3.781, 4.778, 5.774};

        std::vector<std::vector<Real> > data = {
            {0.5131, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.3366, 0.3291,
             0.0000, 0.0000},
            {0.5864, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.3178, 0.3129,
             0.3008, 0.0000},
            {0.6597, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.3019, 0.2976,
             0.2975, 0.0000},
            {0.7330, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.2863, 0.2848,
             0.2848, 0.0000},
            {0.7697, 0.0000, 0.0000, 0.0000, 0.3262, 0.3079, 0.3001, 0.2843, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.8063, 0.0000, 0.0000, 0.0000, 0.3058, 0.2936, 0.2876, 0.2753, 0.2713, 0.2711, 0.2711,
             0.2722, 0.2809},
            {0.8430, 0.0000, 0.0000, 0.0000, 0.2887, 0.2798, 0.2750, 0.2666, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.8613, 0.3365, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.8796, 0.3216, 0.2906, 0.2764, 0.2717, 0.2663, 0.2637, 0.2575, 0.2555, 0.2580, 0.2585,
             0.2611, 0.2693},
            {0.8979, 0.3043, 0.2797, 0.2672, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.9163, 0.2880, 0.2690, 0.2578, 0.2557, 0.2531, 0.2519, 0.2497, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.9346, 0.2724, 0.2590, 0.2489, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.9529, 0.2586, 0.2488, 0.2405, 0.2407, 0.2404, 0.2411, 0.2418, 0.2410, 0.2448, 0.2469,
             0.2501, 0.2584},
            {0.9712, 0.2466, 0.2390, 0.2329, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {0.9896, 0.2358, 0.2300, 0.2253, 0.2269, 0.2284, 0.2299, 0.2347, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.0079, 0.2247, 0.2213, 0.2184, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.0262, 0.2159, 0.2140, 0.2123, 0.2142, 0.2173, 0.2198, 0.2283, 0.2275, 0.2322, 0.2384,
             0.2392, 0.2486},
            {1.0445, 0.2091, 0.2076, 0.2069, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.0629, 0.2056, 0.2024, 0.2025, 0.2039, 0.2074, 0.2104, 0.2213, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.0812, 0.2045, 0.1982, 0.1984, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.0995, 0.2025, 0.1959, 0.1944, 0.1962, 0.1988, 0.2022, 0.2151, 0.2161, 0.2219, 0.2269,
             0.2305, 0.2399},
            {1.1178, 0.1933, 0.1929, 0.1920, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.1362, 0.0000, 0.0000, 0.0000, 0.1902, 0.1914, 0.1950, 0.2091, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.1728, 0.0000, 0.0000, 0.0000, 0.1885, 0.1854, 0.1888, 0.2039, 0.2058, 0.2122, 0.2186,
             0.2223, 0.2321},
            {1.2095, 0.0000, 0.0000, 0.0000, 0.1867, 0.1811, 0.1839, 0.1990, 0.0000, 0.0000, 0.0000,
             0.0000, 0.0000},
            {1.2461, 0.0000, 0.0000, 0.0000, 0.1871, 0.1785, 0.1793, 0.1945, 0.0000, 0.2054, 0.2103,
             0.2164, 0.2251},
            {1.3194, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.1988, 0.2054,
             0.2105, 0.2190},
            {1.3927, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.1930, 0.2002,
             0.2054, 0.2135},
            {1.4660, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.1849, 0.1964,
             0.2012, 0.0000}};
    ...
    void testAndreasenHugeVolatilityInterpolation(const CalibrationData& data,
        ...
        const std::shared_ptr<AndreasenHugeVolatilityInterpl> andreasenHugeVolInterplation(
            std::make_shared<AndreasenHugeVolatilityInterpl>(calibrationSet, spot, rTS, qTS,
                                                             expected.interpolationType,
                                                             expected.calibrationType));

        const auto [unused, maxError, avgError] = andreasenHugeVolInterplation->calibrationError();
        ...
        for (Size i = 0, n = 0; i < calibrationSet.size(); ++i) {
            ...
            const std::shared_ptr<PricingEngine> fdEngine(
                std::make_shared<FdBlackScholesVanillaEngine>(
                    localVolProcess, std::max<Size>(30, Size(100 * t)), 200, 0,
            ...
            const Volatility lvImpliedVol =
                blackFormulaImpliedStdDevLiRS(optionType, strike, fwd, option->NPV(), discount, 0.0,
                                              Null<Real>(), 1.0, 1e-12) /
                std::sqrt(t);
    ...
    CalibrationData arbitrageData() {
        ...
        for (Size i = 0; i < strikes.size(); ++i) {
            ...
            calibrationSet.push_back(
                std::make_pair(std::make_shared<VanillaOption>(
                                   std::make_shared<PlainVanillaPayoff>(Option::Call, strike),
                                   std::make_shared<EuropeanExercise>(maturityDate)),
                               std::make_shared<SimpleQuote>(vol)));
        }
...
void AndreasenHugeVolatilityInterplTest::testTimeDependentInterestRates() {
    ...
    dates += today, today + Period(41, Days), today + Period(75, Days), today + Period(165, Days),
        today + Period(256, Days), today + Period(345, Days), today + Period(524, Days),
        today + Period(2190, Days);

    const Handle<YieldTermStructure> rTS(std::make_shared<ZeroCurve>(dates, r, dc));
    const Handle<YieldTermStructure> qTS(std::make_shared<ZeroCurve>(dates, q, dc));
    ...
    const std::shared_ptr<HestonModel> hestonModel(std::make_shared<HestonModel>(
        std::make_shared<HestonProcess>(rTS, qTS, spot, 0.09, 2.0, 0.09, 0.4, -0.75)));

    const std::shared_ptr<PricingEngine> hestonEngine(std::make_shared<AnalyticHestonEngine>(
    ...
    for (auto& i : calibrationSet) {
        ...
        const Volatility impliedVol =
            blackFormulaImpliedStdDevLiRS(optionType, strike, fwd, npv, discount, 0.0, Null<Real>(),
                                          1.0, 1e-12) /
            std::sqrt(t);
...
void AndreasenHugeVolatilityInterplTest::testSingleOptionCalibration() {
    ...
    calibrationSet.push_back(std::make_pair(
        std::make_shared<VanillaOption>(std::make_shared<PlainVanillaPayoff>(Option::Call, strike),
                                        std::make_shared<EuropeanExercise>(maturity)),
        std::make_shared<SimpleQuote>(vol)));
    ...
    const AndreasenHugeVolatilityInterpl::CalibrationType calibrationType[] = {
        AndreasenHugeVolatilityInterpl::Put, AndreasenHugeVolatilityInterpl::Call,
    ...
    for (auto i : interpl)
        for (auto j : calibrationType) {
            ...
            const std::shared_ptr<AndreasenHugeVolatilityAdapter> volatilityAdapter =
                std::make_shared<AndreasenHugeVolatilityAdapter>(andreasenHugeVolInterplation);
    ...
    for (auto& i : data) {
        ...
        const std::shared_ptr<AndreasenHugeVolatilityInterpl> andreasenHugeVolInterplation(
            std::make_shared<AndreasenHugeVolatilityInterpl>(
                calibrationSet, spot, rTS, qTS, AndreasenHugeVolatilityInterpl::CubicSpline,
        ...
        for (Real m = -0.7; m < 0.7; m += 0.05) {
            ...
            for (Size weeks = 6; weeks < 52; ++weeks) {
                ...
                const Real g_k =
                    square<Real>()(1 - m * w1 / (2 * w)) - w1 * w1 / 4 * (1 / w + 0.25) + 0.5 * w2;
                ...
                const Real fwdpt =
                    spot->value() * qTS->discount(t + deltaT) / rTS->discount(t + deltaT);
...
void AndreasenHugeVolatilityInterplTest::testBarrierOptionPricing() {
    ...
    Handle<Quote> spot(std::make_shared<SimpleQuote>(100));
    const std::shared_ptr<HestonModel> hestonModel(std::make_shared<HestonModel>(
        std::make_shared<HestonProcess>(rTS, qTS, spot, 0.04, 2.0, 0.04, 0.4, -0.75)));

    const std::shared_ptr<BlackVolTermStructure> hestonVol =
        std::make_shared<HestonBlackVolSurface>(Handle<HestonModel>(hestonModel));

    const std::shared_ptr<GeneralizedBlackScholesProcess> dupireLocalVolProcess =
    ...
    const std::shared_ptr<GeneralizedBlackScholesProcess> andreasenHugeLocalVolProcess =
        std::make_shared<GeneralizedBlackScholesProcess>(
    ...
    barrierOption.setPricingEngine(std::make_shared<FdBlackScholesBarrierEngine>(
        dupireLocalVolProcess, 50, 100, 0, FdmSchemeDesc::Douglas(), true, 0.2));
...
void AndreasenHugeVolatilityInterplTest::testPeterAndFabiensExample() {
    ...
    const std::shared_ptr<AndreasenHugeVolatilityInterpl> andreasenHugeVolInterplation(
        std::make_shared<AndreasenHugeVolatilityInterpl>(data.calibrationSet, data.spot, data.rTS,
                                                         data.qTS));
...
void AndreasenHugeVolatilityInterplTest::testDifferentOptimizers() {
    ...
    const std::shared_ptr<OptimizationMethod> optimizationMethods[] = {
        std::make_shared<LevenbergMarquardt>(), std::make_shared<BFGS>(),
...
void AndreasenHugeVolatilityInterplTest::testMovingReferenceDate() {
    ...
    AndreasenHugeVolatilityInterpl::CalibrationSet calibrationSet(
        1, std::make_pair(std::make_shared<VanillaOption>(
                              std::make_shared<PlainVanillaPayoff>(Option::Call, s0),
                              std::make_shared<EuropeanExercise>(maturity)),
                          std::make_shared<SimpleQuote>(impliedVol)));

    const std::shared_ptr<AndreasenHugeVolatilityInterpl> andreasenHugeVolInterplation(
        std::make_shared<AndreasenHugeVolatilityInterpl>(calibrationSet, spot, ts, ts));


    const Real tol = 1e-8;
    const std::shared_ptr<AndreasenHugeVolatilityAdapter> volatilityAdapter(
        std::make_shared<AndreasenHugeVolatilityAdapter>(andreasenHugeVolInterplation, tol));
    ...
    for (auto expiry : expiries) {
        ...
        for (auto m : moneyness) {
            ...
            if (std::fabs(mn) < 3.72 * vol->value()) {
                const std::shared_ptr<VanillaOption> option = std::make_shared<VanillaOption>(
                    std::make_shared<PlainVanillaPayoff>(
...
test_suite* AndreasenHugeVolatilityInterplTest::suite(SpeedLevel speed) {
    test_suite* suite = BOOST_TEST_SUITE("Andreasen-Huge volatility interpolation tests");

    suite->add(
        QUANTLIB_TEST_CASE(&AndreasenHugeVolatilityInterplTest::testSingleOptionCalibration));
    ...
    if (speed == Slow) {
        ...
        suite->add(
            QUANTLIB_TEST_CASE(&AndreasenHugeVolatilityInterplTest::testAndreasenHugeCallPut));
        suite->add(
            QUANTLIB_TEST_CASE(&AndreasenHugeVolatilityInterplTest::testLinearInterpolation));
        suite->add(QUANTLIB_TEST_CASE(
            &AndreasenHugeVolatilityInterplTest::testPiecewiseConstantInterpolation));
        suite->add(
            QUANTLIB_TEST_CASE(&AndreasenHugeVolatilityInterplTest::testBarrierOptionPricing));
        suite->add(QUANTLIB_TEST_CASE(
