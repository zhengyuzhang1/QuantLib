    ...
    class NonstandardSwap : public Swap {
      public:
        ...
        NonstandardSwap(
            ...
            Schedule fixedSchedule, std::vector<Real> fixedRate,
            DayCounter fixedDayCount, Schedule floatingSchedule,
            std::shared_ptr<IborIndex> iborIndex, const Real gearing,
