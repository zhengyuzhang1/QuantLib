...
namespace QuantLib
{
    ...
    public:
        ...
        const std::vector<std::shared_ptr<PiecewiseConstantVariance> >& interpolatedVariances() const override;
        const std::vector<std::shared_ptr<PiecewiseConstantVariance> >& originalVariances() const override;
