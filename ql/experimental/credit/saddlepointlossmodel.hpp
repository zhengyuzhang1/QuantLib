...
namespace QuantLib {
    ...
    */
    ...
    class SaddlePointLossModel : public DefaultLossModel {
      public:
        explicit SaddlePointLossModel(const std::shared_ptr<ConstantLossLatentmodel<CP> >& m)
        : copula_(m) {}
      ...
      protected:
        ...
        */
        ...
        CumGen0234DerivCond(const std::vector<Real>& invUncondProbs,
                            Real saddle,
                            const std::vector<Real>& mktFactor) const;
      ...
      protected:
        Disposable<std::vector<Real> > splitLossCond(const std::vector<Real>& invUncondProbs,
                                                     Real loss,
        ...
        expectedShortfallSplitCond(const std::vector<Real>& invUncondProbs,
                                   Real lossPerc,
                                   const std::vector<Real>& mktFactor) const;
      ...
      protected:
        ...
        void resetModel() override {
            ...
            attachRatio_ =
                std::min(basket_->remainingAttachmentAmount() / basket_->remainingNotional(), 1.);
            detachRatio_ =
                std::min(basket_->remainingDetachmentAmount() / basket_->remainingNotional(), 1.);
    ...
    inline Real SaddlePointLossModel<CP>::CumulantGenerating(const Date& date, Real s) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::CumulantGeneratingCond, this,
                      std::cref(invUncondProbs), s, _1)));
    }
    ...
    inline Real SaddlePointLossModel<CP>::CumGen1stDerivative(const Date& date, Real s) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::CumGen1stDerivativeCond, this,
                      std::cref(invUncondProbs), s, _1)));
    }
    ...
    inline Real SaddlePointLossModel<CP>::CumGen2ndDerivative(const Date& date, Real s) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::CumGen2ndDerivativeCond, this,
                      std::cref(invUncondProbs), s, _1)));
    }
    ...
    inline Real SaddlePointLossModel<CP>::CumGen3rdDerivative(const Date& date, Real s) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::CumGen3rdDerivativeCond, this,
                      std::cref(invUncondProbs), s, _1)));
    }
    ...
    inline Real SaddlePointLossModel<CP>::CumGen4thDerivative(const Date& date, Real s) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::CumGen4thDerivativeCond, this,
                      std::cref(invUncondProbs), s, _1)));
    }

    template <class CP>
    inline Probability SaddlePointLossModel<CP>::probOverLoss(const Date& d,
                                                              Real trancheLossFract) const {
        using namespace std::placeholders;
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::probOverLossCond, this, std::cref(invUncondProbs),
                      trancheLossFract, _1)));
    }
    ...
    inline Probability SaddlePointLossModel<CP>::probOverPortfLoss(const Date& d, Real loss) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::probOverLossPortfCond, this,
                      std::cref(invUncondProbs), loss, _1)));
    }
    ...
    inline Real SaddlePointLossModel<CP>::expectedTrancheLoss(const Date& d) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::conditionalExpectedTrancheLoss, this,
                      std::cref(invUncondProbs), _1)));
    }
    ...
    inline Probability SaddlePointLossModel<CP>::probDensity(const Date& d, Real loss) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
            std::bind(&SaddlePointLossModel<CP>::probDensityCond, this, std::cref(invUncondProbs),
                      loss, _1)));
    }

    template <class CP>
    inline Disposable<std::vector<Real> > SaddlePointLossModel<CP>::splitVaRLevel(const Date& date,
                                                                                  Real s) const {
        using namespace std::placeholders;
        ...
        return copula_->integratedExpectedValueV(
            std::function<Disposable<std::vector<Real> >(const std::vector<Real>& v1)>(std::bind(
                &SaddlePointLossModel<CP>::splitLossCond, this, std::cref(invUncondProbs), s, _1)));
    }
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::CumulantGeneratingCond(const std::vector<Real>& invUncondProbs,
                                                     Real lossFraction,
                                                     const std::vector<Real>& mktFactor) const {
        ...
        for (Size iName = 0; iName < nNames; iName++) {
            Probability pBuffer =
                copula_->conditionalDefaultProbabilityInvP(invUncondProbs[iName], iName, mktFactor);
            sum += std::log(1. - pBuffer +
                            pBuffer * std::exp(remainingNotionals_[iName] *
                                               (1. - copula_->conditionalRecoveryInvP(
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::CumGen1stDerivativeCond(const std::vector<Real>& invUncondProbs,
                                                      Real saddle,
                                                      const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real sum = 0.;
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::CumGen2ndDerivativeCond(const std::vector<Real>& invUncondProbs,
                                                      Real saddle,
                                                      const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real sum = 0.;
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::CumGen3rdDerivativeCond(const std::vector<Real>& invUncondProbs,
                                                      Real saddle,
                                                      const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real sum = 0.;
        ...
        for (Size iName = 0; iName < nNames; iName++) {
            ...
            sum +=
                (suma3 + (2. * std::pow(suma1, 3.) / suma0 - 3. * suma1 * suma2) / suma0) / suma0;
        }
        return sum;
    }
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::CumGen4thDerivativeCond(const std::vector<Real>& invUncondProbs,
                                                      Real saddle,
                                                      const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real sum = 0.;
    ...
    SaddlePointLossModel<CP>::CumGen0234DerivCond(const std::vector<Real>& invUncondProbs,
                                                  Real saddle,
                                                  const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real deriv0 = 0.,
        ...
        return std::tuple<Real, Real, Real, Real>(deriv0, deriv2, deriv3, deriv4);
    }

    template <class CP>
    std::tuple<Real, Real> /// DISPOSABLE????
    SaddlePointLossModel<CP>::CumGen02DerivCond(const std::vector<Real>& invUncondProbs,
                                                Real saddle,
                                                const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real deriv0 = 0.,
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::findSaddle(const std::vector<Real>& invUncondPs,
        ...
        //
        Probability pMaxName =
            copula_->conditionalDefaultProbabilityInvP(invUncondPs[iNamMax], iNamMax, mktFactor);
        ...
        Real saddleMax = 1. / (lgds[iNamMax] / remainingNotional_) *
                         std::log((lgds[iNamMax] / remainingNotional_ - deltaMin) *
                                  (1. - pMaxName) / (pMaxName * deltaMin));
    ...
    template <class CP>
    Probability
    SaddlePointLossModel<CP>::probOverLossCond(const std::vector<Real>& invUncondPs,
                                               Real trancheLossFract,
                                               const std::vector<Real>& mktFactor) const {
        Real portfFract =
            attachRatio_ +
            trancheLossFract * (detachRatio_ - attachRatio_); // these are remaining ratios
    ...
    */
    template <class CP>
    Probability
    SaddlePointLossModel<CP>::probOverLossPortfCond(const std::vector<Real>& invUncondProbs,
                                                    Real loss,
                                                    const std::vector<Real>& mktFactor) const {
        ...
        */
        ...
        auto [baseVal, secondVal, K3Saddle, K4Saddle] =
            CumGen0234DerivCond(invUncondProbs, saddlePt, mktFactor);
    ...
    Probability SaddlePointLossModel<CP>::probOverLossPortfCond1stOrder(
        const std::vector<Real>& invUncondPs, Real loss, const std::vector<Real>& mktFactor) const {
        if (loss <= QL_EPSILON)
            return 1.;
        const Size nNames = remainingNotionals_.size();
        ...
        for (Size iName = 0; iName < nNames; iName++)
            averageRecovery_ +=
                copula_->conditionalRecoveryInvP(invUncondPs[iName], iName, mktFactor);
        averageRecovery_ = averageRecovery_ / nNames;
        ...
        auto [baseVal, secondVal] = CumGen02DerivCond(invUncondPs, saddlePt, mktFactor);
    ...
    */
    ...
    Probability SaddlePointLossModel<CP>::probDensityCond(
        ...
        auto [K0Saddle, K2Saddle, K3Saddle, K4Saddle] =
            CumGen0234DerivCond(invUncondPs, saddlePt, mktFactor);
    ...
    */
    ...
    Disposable<std::vector<Real> > SaddlePointLossModel<CP>::splitLossCond(
        const std::vector<Real>& invUncondProbs, Real loss, std::vector<Real> mktFactor) const {
        const Size nNames = remainingNotionals_.size();
    ...
    template <class CP>
    Real
    SaddlePointLossModel<CP>::conditionalExpectedLoss(const std::vector<Real>& invUncondProbs,
                                                      const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real eloss = 0.;
        /// USE STL.....-------------------
    ...
    Real SaddlePointLossModel<CP>::conditionalExpectedTrancheLoss(
        const std::vector<Real>& invUncondProbs, const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        Real eloss = 0.;
        /// USE STL.....-------------------
        for (Size iName = 0; iName < nNames; iName++) {
    ...
    template <class CP>
    Disposable<std::vector<Real> >
    SaddlePointLossModel<CP>::expectedShortfallSplitCond(const std::vector<Real>& invUncondProbs,
                                                         Real lossPerc,
                                                         const std::vector<Real>& mktFactor) const {
        const Size nNames = remainingNotionals_.size();
        std::vector<Real> lgds;
        ...
        for (Size iName = 0; iName < nNames; iName++) {
            ...
            vola[iName] =
                lgds[iName] * lgds[iName] * pBuffer * (1. - pBuffer) / remainingNotionals_[iName];
    ...
    Real SaddlePointLossModel<CP>::expectedShortfallTrancheCond(
        ...
        */
        ...
        Real probLOver =
            probOverLossPortfCond(invUncondProbs, basket_->detachmentAmount(), mktFactor);
        ...
        return expectedShortfallFullPortfolioCond(
                   invUncondProbs, std::max(lossPerc, basket_->attachmentAmount()), mktFactor) +
               expectedShortfallFullPortfolioCond(invUncondProbs, basket_->detachmentAmount(),
                                                  mktFactor) -
               correctionTerm;
    }
    ...
    Real SaddlePointLossModel<CP>::expectedShortfall(const Date& d, Probability percProb) const {
        ...
        return copula_->integratedExpectedValue(std::function<Real(const std::vector<Real>& v1)>(
                   std::bind(&SaddlePointLossModel<CP>::expectedShortfallFullPortfolioCond, this,
                             std::cref(invUncondProbs), lossPerc, _1))) /
               (1. - percProb);
